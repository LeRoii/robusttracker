...
class MppEncoder {
 public:
	...
	void setUp(int width, int height,int bps ,int profile ,int fps);
    void MppEncdoerInit(int width, int height, int bps ,int profile ,int fps){setUp(width, height,  bps ,profile, fps); }
